...
cd ${TMPDIR}
python /home/ucabpod/Scratch/gopgar/review_fig3/scripts/run_constant.py ${index} ${n} ${p} ${norm}
tar zcvf /home/ucabpod/Scratch/gopgar/review_fig3/raw_data/constant${index}.tar.gz $TMPDIR
